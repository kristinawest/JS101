//we have loan amount
//we have annual percentage rate
//we have loan duration

//need to calculate monthly interest rate
//need to calculate monthly loan duration in months

//monthly payment = loan amount * (monthly interest rate / (1 - Math.pow((1 + monthly interest rate), (- loan duration in months))) );
//output is payment amount in dollars and cents
